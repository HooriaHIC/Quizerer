			...
			{loading ? (
				<Loader />
					...
					<>
						...
						{userId ? (
							<Modal>
								<p className={quizStyle.header}>Quiz has been created!</p>
								...
								<div className={quizStyle.info}>
									<p>Share the above link with<br></br>
										your friends To check your results,<br></br>
										visit the above link from this browser only!</p>
								</div>
							</Modal>
						) : null}
					</>
